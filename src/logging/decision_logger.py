...
class DecisionLogger:
    ...
    def log_decision(self, 
                    ...
                    llm_response: Optional[str] = None,
                    context_data: Optional[Dict[str, Any]] = None,
                    log_level: Optional[LogLevel] = None) -> DecisionEvent:
        """
        ...
        event = DecisionEvent(
            ...
            full_reasoning=full_reasoning if effective_log_level == LogLevel.VERBOSE else None,
            llm_prompt=llm_prompt if effective_log_level == LogLevel.VERBOSE else None,
            llm_response=llm_response if effective_log_level == LogLevel.VERBOSE else None,
...
class LogAnalyzer:
    ...
    def filter_decisions(self,
                        ...
                        max_confidence: Optional[float] = None) -> List[DecisionEvent]:
        """
    ...
    def get_decision_summary(self, decisions: Optional[List[DecisionEvent]] = None) -> Dict[str, Any]:
        """
