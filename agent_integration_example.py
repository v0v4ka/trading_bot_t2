...
class BaseAgent:
    ...
    def _log_decision(self, decision_type: DecisionType, action_taken: str,
                     confidence_score: float, reasoning_summary: str,
...
class RiskManagementAgent(BaseAgent):
    ...
    def assess_trade_risk(self, trade_request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if stop_loss:
            ...
            risk_reward_ratio = abs(take_profit - current_price) / risk_per_unit if take_profit else 1.0
        else:
...
def demo_agent_integration():
    ...
    logger = DecisionLogger(
        log_file_path="logs/agent_integration.log",
