...
class TestChartVisualizer:
    ...
    def test_plot_awesome_oscillator_success(self, mock_ao, sample_ohlcv_data):
        ...
        mock_ax.axhline.assert_called_once_with(y=0, color='black', linestyle='-', linewidth=1)
    ...
    def test_plot_agent_decisions(self, sample_ohlcv_data, sample_backtest_results):
        ...
        # Should not raise exception
        visualizer._plot_agent_decisions(mock_ax, sample_ohlcv_data, sample_backtest_results)
    ...
    def test_plot_trade_annotations(self, sample_ohlcv_data, sample_backtest_results):
        ...
        # Should not raise exception
        visualizer._plot_trade_annotations(mock_ax, sample_ohlcv_data, sample_backtest_results)
    ...
    def test_configure_chart_appearance(self, mock_setp, mock_tight_layout, sample_ohlcv_data):
        ...
        # Should not raise exception
        visualizer._configure_chart_appearance(mock_fig, sample_ohlcv_data, "Test Title")
        
        # Verify suptitle was set
        mock_fig.suptitle.assert_called_once_with("Test Title", fontsize=16, weight='bold')
...
class TestCreateQuickChart:
    ...
    def test_create_quick_chart_basic(self, mock_create_chart, sample_data):
        ...
        mock_create_chart.assert_called_once_with(
            sample_data, None, "Test Chart", None
        )
        assert result == mock_fig
