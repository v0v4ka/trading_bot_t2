...
from src.logging.decision_logger import (
    DecisionLogger, DecisionEvent, LogAnalyzer,
    LogLevel, DecisionType
)
...
class TestDecisionEvent(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(result['full_reasoning'], "Detailed analysis of market conditions...")
        self.assertEqual(result['llm_prompt'], "Analyze the current market trend")
        self.assertEqual(result['llm_response'], "Based on indicators, trend is bullish")
        self.assertEqual(result['context_data'], {"symbol": "EURUSD", "timeframe": "1h"})
    ...
    def test_from_dict(self):
        ...
        self.assertEqual(reconstructed.reasoning_summary, self.test_event.reasoning_summary)
...
class TestDecisionLogger(unittest.TestCase):
    ...
    def test_log_decision_verbose_mode(self):
        ...
        with open(self.log_file, 'r') as f:
            ...
            self.assertEqual(log_entry['event']['full_reasoning'], 'Detailed analysis of market conditions')
            self.assertEqual(log_entry['event']['llm_prompt'], 'Analyze the current market trend')
    ...
    def test_log_level_override(self):
        ...
        with open(self.log_file, 'r') as f:
            ...
            self.assertEqual(log_entry['log_level'], 'verbose')
            self.assertEqual(log_entry['event']['full_reasoning'], 'This should be logged due to override')
...
class TestLogAnalyzer(unittest.TestCase):
    ...
    def test_get_decision_summary(self):
        ...
        expected_agents = {
            "Agent1 (SignalGenerator)": 2,
            "Agent2 (RiskManager)": 1
        }
