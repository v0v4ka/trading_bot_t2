...
class TestBacktestEngine:
    ...
    def test_load_historical_data(self, mock_data_provider):
        ...
        mock_provider_instance.get_historical_data.return_value = sample_df
        ...
        mock_provider_instance.get_historical_data.assert_called_once_with(
    ...
    def test_get_decisions(self):
        ...
        mock_decision_agent.make_decisions.return_value = mock_decisions
