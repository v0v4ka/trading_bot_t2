...
import numpy as np
from src.backtesting.metrics import Trade, BacktestResults, PerformanceAnalyzer
...
class TestPerformanceAnalyzer:
    ...
    def test_consecutive_trades_calculation(self):
        ...
        trades = [
            Trade(entry_time=datetime(2023, 1, 1), exit_time=datetime(2023, 1, 2),
                  entry_price=100.0, exit_price=105.0, quantity=10.0, trade_type="BUY"),  # Win
            Trade(entry_time=datetime(2023, 1, 2), exit_time=datetime(2023, 1, 3),
                  entry_price=100.0, exit_price=108.0, quantity=10.0, trade_type="BUY"),  # Win
            Trade(entry_time=datetime(2023, 1, 3), exit_time=datetime(2023, 1, 4),
                  entry_price=100.0, exit_price=95.0, quantity=10.0, trade_type="BUY"),   # Loss
            Trade(entry_time=datetime(2023, 1, 4), exit_time=datetime(2023, 1, 5),
                  entry_price=100.0, exit_price=103.0, quantity=10.0, trade_type="BUY"),  # Win
            Trade(entry_time=datetime(2023, 1, 5), exit_time=datetime(2023, 1, 6),
                  entry_price=100.0, exit_price=97.0, quantity=10.0, trade_type="BUY"),   # Loss
            Trade(entry_time=datetime(2023, 1, 6), exit_time=datetime(2023, 1, 7),
                  entry_price=100.0, exit_price=96.0, quantity=10.0, trade_type="BUY"),   # Loss
        ]
